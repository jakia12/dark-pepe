      ...
      (l =
        "off-canvas" === e || "full-width" === e
          ? ((n = document.querySelectorAll(
            ...
            (o = a.classList.contains("ast-header-break-point")
          ...
          : a.classList.contains("ast-header-break-point")
          ? ((n = document.querySelectorAll("#ast-mobile-header")),
            (r = !(
              0 <
              (l = (o = document.querySelectorAll(
                "#ast-mobile-header .main-header-menu-toggle"
              )).length)
            ))
              ? 1
              : l)
          : ((n = document.querySelectorAll("#ast-desktop-header")),
        ...
        for (var d, i = 0; i < n.length; i++)
          if (
            ...
            (d = document
              ...
              : n[i].querySelectorAll("ul.main-header-menu .ast-menu-toggle"))
              .length
          )
  ...
  (astraNavMenuTogglePro = function (e, a, t, l) {
    ...
    var n = e.target.closest("#ast-desktop-header"),
      ...
      r =
        ((n =
          null != n && "" !== n
            ? n.querySelector(".main-header-menu-toggle")
    ...
    if ("desktop" === e.currentTarget.trigger_type)
      return (
        null !== r &&
          "" !== r &&
          void 0 !== r &&
          (astraToggleClass(r, "toggle-on"),
          r.classList.contains("toggle-on")
            ? (r.style.display = "block")
            : (r.style.display = "")),
        astraToggleClass(n, "toggled"),
        void (n.classList.contains("toggled")
          ? (a.classList.add("ast-main-header-nav-open"),
            "dropdown" === t && (o.style.display = "block"))
    ...
    (e = document.querySelectorAll(
      ...
      (n = !1);
    if (
      (null !== l.closest("#ast-fixed-header") &&
        ((e = document.querySelectorAll(
      ...
      return !1;
    for (
      var s = e[r].querySelectorAll(".menu-item-has-children"), d = 0;
      d < s.length;
      d++
    ) {
    ...
    -1 !== (l.getAttribute("class") || "").indexOf("main-header-menu-toggle") &&
      (astraToggleClass(e[r], "toggle-on"),
      astraToggleClass(menu_toggle_all[r], "toggled"),
      n &&
        1 < menu_toggle_all.length &&
        astraToggleClass(menu_toggle_all[1], "toggled"),
      e[r].classList.contains("toggle-on")
